...
function listaralumnos_del_grado(idgradoencurso){
    ...
    tableAlumnos = $("#alumnos_del_curso").DataTable({
        ...
        "processing": true,
        "ajax": {
            url: "../controlador/docente/controlador_alumnos_listar.php",
            type: 'POST',
            data:{idgradoencurso:idgradoencurso}
        },
        ...
        }, 
        {
         ...
         {
            "defaultContent": "<button style='font-size:13px;' type='button' class='notas btn btn-warning'><i class='fa fa-plus-square' title='Notas'></i></button>&nbsp;<button style='font-size:13px;' type='button' class='editar btn btn-info'><i class='fa fa-edit' title='editar'></i></button>&nbsp;<button style='font-size:13px;' type='button' class='vernotas btn btn-prymari'><i class=' glyphicon glyphicon-eye-open' title='ver notas'></i></button>"
        }],
        "language": idioma_espanol,
        select: true
    });
...
$('#alumnos_del_curso').on('click', '.editar', function() {
   ...
   // alert('alumno: '+idalumno+' curso:'+cursoid);
    ...
    $("#edit_nombreAlumno").html(data.apellidop);
   ...
   $.ajax({
      ...
      $("#modal_editar_notas").modal({
       ...
       $("#modal_editar_notas").modal('show');
        ...
        $("#edit_practica1").val(data[0][0]);
        $("#edit_practica2").val(data[0][1]);
        $("#edit_practica3").val(data[0][2]);
        $("#edit_practica4").val(data[0][3]);

        $("#edit_trabajo1").val(data[0][4]);
        $("#edit_trabajo2").val(data[0][5]);
        $("#edit_trabajo3").val(data[0][6]);
        $("#edit_trabajo4").val(data[0][7]);

        $("#edit_parcial1").val(data[0][8]);
        $("#edit_parcial2").val(data[0][9]);
        $("#edit_parcial3").val(data[0][10]);
        $("#edit_parcial4").val(data[0][11]);

        $("#edit_exsamen1").val(data[0][12]);
        $("#edit_exsamen2").val(data[0][13]);
...
function recetearmodal(){
       $("#edit_practica1").val('0.0');
        $("#edit_practica2").val('0.0');
        $("#edit_practica3").val('0.0');
        $("#edit_practica4").val('0.0');

        $("#edit_trabajo1").val('0.0');
        $("#edit_trabajo2").val('0.0');
        $("#edit_trabajo3").val('0.0');
        $("#edit_trabajo4").val('0.0');

        $("#edit_parcial1").val('0.0');
        $("#edit_parcial2").val('0.0');
        $("#edit_parcial3").val('0.0');
        $("#edit_parcial4").val('0.0');

        $("#edit_exsamen1").val('0.0');
        $("#edit_exsamen2").val('0.0');  
}
...
if (cont1 == 0) {
    cont1++;
       var scntDiv1 = $('#dynamicDiv');
              ...
              $('<div id="divinput"><div class="col-lg-5"><label for="">Pra 3:</label><input type="number" class="form-control" id="practica3" placeholder="parcial 3" disabled></div><br><div class="col-lg-5"><label for="">Pra 4:</label><input type="number" class="form-control"  id="practica4" placeholder="parcial 4" disabled> </div><div class="col-lg-2"><br><a class="btn btn-danger btn-sm" class="col-lg-2" href="javascript:void(0)" id="remInput">'+
...
if (cont2 == 0) {
    cont2++;
       var divtrabj = $('#divtrabajo');
              $('<div id="divinput"><div class="col-lg-5"><label for="">Trab 3:</label><input type="number" class="form-control" id="trabajo3" placeholder="ingrese Nota" disabled ></div><br><div class="col-lg-5"><label for="">trabajo 4:</label><input type="number" class="form-control"  id="trabajo4" placeholder="ingrese Nota" disabled> </div><div class="col-lg-2"><br><a class="btn btn-danger btn-sm" class="col-lg-2" href="javascript:void(0)" id="remtrabaj">'+'<span class="fa fa-trash" aria-hidden="true"></span> </a></div></div>'+
                ''+
                ''+
              ''+
          '').appendTo(divtrabj);
...
if (cont3 == 0) {
    cont3++;
       var divparcial = $('#divparcial');
              $('<div id="divinput"><div class="col-lg-5"><label for="">Parcial 3:</label><input type="number" class="form-control" id="parcial3" placeholder="ingrese Nota" disabled></div><br><div class="col-lg-5"><label for="">Patcial 4:</label><input type="number" class="form-control"  id="parcial4" placeholder="ingrese Nota" disabled> </div><div class="col-lg-2"><br><a class="btn btn-danger btn-sm" class="col-lg-2" href="javascript:void(0)" id="remparcial">'+'<span class="fa fa-trash" aria-hidden="true"></span> </a></div></div>'+
                ''+
                ''+
              ''+
          '').appendTo(divparcial);
