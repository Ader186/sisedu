...
function crearHorarios() {
               ...
               // var idsemet=$("inpHsemestreH").val();
                ...
                document.addEventListener("drop", function (event) {
                    ...
                    if (event.target.className == "dropzone") {
                        ...
                        guardarhorario(idaleat,hora, dia, curso, idtd,idgradoH);
            ...
            function guardarhorario(idaleat,hora, dia, curso, idtd,idgradoH) { 
...
$('#tabla_horarios').on('click', '.verhorario', function() {
  ...
  var id=data.codigo;
   $('.loader').show();
      $("#codigoHorario").val(data.codigo);
       $("#variableJS").val(data.codigo);
