         ...
         <div class="row ">
            <input type="text" name="" id="idalumno" hidden>
              ...
              <div class="col-lg-6">
                ...
                <div class="col-lg-5">
                   <label for="">Prac 1:</label>
                   <input type="text" class="form-control" id="practica1" value="14" ><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">Pra 2:</label>
                   <input type="text" class="form-control" id="practica2"  value="12"><br>
               ...
               <div class="col-lg-5">
                   <label for="">Trab 1:</label>
                   <input type="text" class="form-control" id="trabajo1"  value="14"><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">trab 2:</label>
                   <input type="text" class="form-control" id="trabajo2"  value="13"><br>
               ...
               <div class="col-lg-5">
                   ...
                   <input type="text" class="form-control" id="parcial1"  value="4"><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">parcial 2:</label>
                   <input type="text" class="form-control" id="parcial2"  value="5"><br>
               ...
               <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id=exsamen1 value="8"><br>
                </div>
                <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;EF-20%</span>
                    <input type="text" class="form-control" id="exsamen2" disabled><br>
                </div>
         ...
         <div class="row ">
            <input type="text" name="" id="edit_idalumno"  hidden>
              ...
              <div class="col-lg-6">
                ...
                <div class="col-lg-12">
                   <label for="">Pr&aacute;cticas</label>&nbsp;<span class='label label-success'>&nbsp;20%</span>
                   <a class="btn btn-success btn-circle btn-sm" onclick="Edit_Addnotas()">
                     <span class="fa fa-plus-circle" aria-hidden="true"></span>
                     </a>
                ...
                <div class="col-lg-5">
                   <label for="">Prac 1:</label>
                   <input type="text" class="form-control" id="edit_practica1" disabled><br>
  
               </div>
                <div class="col-lg-5">
                   <label for="">Pra 2:</label>
                   <input type="text" class="form-control" id="edit_practica2"  disabled><br>
                   
               </div>
                    <div id="Edit_dynamicDiv"></div><br>

                <div class="col-lg-12">
                   <label for="">Trabajos</label>&nbsp;<span class='label label-success'>&nbsp;20%</span>
                   <a class="btn btn-primary btn-circle btn-sm" onclick="Edit_Addtrabajo()">
                     <span class="fa fa-plus-circle" aria-hidden="true"></span>
                     </a>
               ...
               <div class="col-lg-5">
                   <label for="">Trab 1:</label>
                   <input type="text" class="form-control" id="edit_trabajo1"  disabled><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">trab 2:</label>
                   <input type="text" class="form-control" id="edit_trabajo2"  disabled><br>
                   
               </div>

               <div id="Edit_divtrabajo"></div>
            

               <div class="col-lg-12">
                   <label for="">Parciales</label>&nbsp;<span class='label label-success'>&nbsp;20%</span>
                   <a class="btn btn-warning btn-circle btn-sm" onclick="Edit_AddParcial()">
                     <span class="fa fa-plus-circle" aria-hidden="true"></span>
                     </a>
               ...
               <div class="col-lg-5">
                   <label for="">Parcial 1:</label>
                   <input type="text" class="form-control" id="edit_parcial1"  disabled><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">parcial 2:</label>
                   <input type="text" class="form-control" id="edit_parcial2"  disabled><br>
                   
               </div>

               <div id="Edit_divparcial"></div>

               <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;MC-20%</span>
                    <input type="text" class="form-control" id=edit_exsamen1 disabled><br>
                </div>
                <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;EF-20%</span>
                    <input type="text" class="form-control" id="edit_exsamen2" value="0.0"><br>
                </div>
