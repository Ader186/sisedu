<aside class="main-sidebar" >
    ...
    <section class="sidebar" ><br>
      ...
      <li>
          <a onclick="cargar_contenido('contenido_principal','titulado/vista_listar_titulado.php')">
            <i class=" fa fa-graduation-cap"></i> <span style="cursor: pointer;">Titulados</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
